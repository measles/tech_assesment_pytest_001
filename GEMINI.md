...
- **Mandate:** Always provide descriptive error messages for all `assert` statements (e.g., `assert response.status_code == 200, "Expected 200 OK, but got {response.status_code}"`). Messages should be short, plain, and explain what went wrong.
